...
const BoxChart = ({ chartData }) => {
  ...
  useEffect(() => {
    ...
    const adjustedWidth = dimensions.width - 0.1 * dimensions.width;
    const adjustedHeight = dimensions.height - 0.1 * dimensions.height; // Similar adjustment for height if needed
